...
#Função que cria um contexto aleatoriamente
#dialog é uma lista contendo toda a sessão de conversa
#rng objeto utilizado para gerar números aleatórios
...
def create_single_dialog_train_example(context_dialog_path, candidate_dialog_paths, rng, positive_probability,
                                       minimum_context_length=2,max_context_length=20, num=1):
    """
...
if __name__ == '__main__':
    ...
    def create_eval_dataset(args, file_list_csv):
        ...
        data_set = create_examples(dialog_paths,
                                   ...
                                   lambda context_dialog, candidates : create_single_dialog_test_example(context_dialog, candidates, rng,
                                                                     args.n, args.max_context_length, args.num))
        # output the dataset
    ...
    def train_cmd(args):
        ...
        train_set = create_examples(dialog_paths,
                                    ...
                                    create_single_dialog_train_example(context_dialog, candidates, rng,
                                                                       args.p, max_context_length=args.max_context_length, num=args.turno))
    ...
    parser_train.add_argument('-e', type=int, default=10, help='number of examples to generate')
    parser_train.add_argument('-num', '--turno', type=int, default=1, help='number of examples to generate')
...
if __name__ == '__main__':
    ...
    parser_train = subparsers.add_parser('train', help='trainset generator')
    parser_train.add_argument('-p', type=float, default=0.5, help='positive example probability')
    parser_train.add_argument('-e', '--examples', type=int, default=10, help='number of examples to generate')
    parser_train.set_defaults(func=train_cmd)
